[] spawn {
	...
	_actionText = if (isLocalized "STR_chvd_title") then {localize "STR_chvd_title"} else {"Settings"};
	player addAction [format["<t color=""#FF0000"">%1</t>",_actionText], CHVD_fnc_openDialog, [], -99, false, true];
	player addEventHandler ["Respawn", format ["<t color=""#FF0000"">%1</t>",_actionText], CHVD_fnc_openDialog, [], -99, false, true]];
